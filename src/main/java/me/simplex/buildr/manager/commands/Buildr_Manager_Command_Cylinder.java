...
public class Buildr_Manager_Command_Cylinder extends StdArgBuilderCommand {

    public Buildr_Manager_Command_Cylinder(Buildr plugin) {
        super(plugin, "cylinder", "buildr.cmd.cylinder");
    }
    ...
    public void doBuildCommand(CommandSender sender,
        ...
        sendTo(sender, MsgType.INFO,
                "Rightclick on the center of your cylinder while holding a stick to continue");
    }
}
