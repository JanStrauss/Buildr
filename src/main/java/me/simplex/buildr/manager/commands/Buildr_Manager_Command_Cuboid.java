...
public class Buildr_Manager_Command_Cuboid extends StdArgBuilderCommand {

    public Buildr_Manager_Command_Cuboid(Buildr plugin) {
        super(plugin, "cuboid", "buildr.cmd.cuboid");
    }
    ...
    public void doBuildCommand(CommandSender sender,
        ...
        plugin.getStartedBuildings().add(new Buildr_Manager_Builder_Cuboid((Player) sender, material,
