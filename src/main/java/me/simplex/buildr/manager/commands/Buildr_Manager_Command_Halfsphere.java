...
public class Buildr_Manager_Command_Halfsphere extends StdArgBuilderCommand {

	public Buildr_Manager_Command_Halfsphere(Buildr plugin) {
		super(plugin, "halfsphere", "buildr.cmd.sphere");
	}
    ...
    public void doBuildCommand(CommandSender sender,
        ...
        plugin.getStartedBuildings().add(new Buildr_Manager_Builder_Sphere((Player) sender, material,
